...
export const DisabledCountrySelect = ({
  ...
  return (
    <Button
      ...
      disabled={true}
    >
      <FlagComponent country={selectedCountry} countryName="Pakistan" />
    </Button>
  );
};
...
const FlagComponent = ({ country, countryName }: RPNInput.FlagProps) => {
  ...
  return (
    <span className="flex h-4 w-8">{Flag && <Flag title={countryName} />}</span>
  );
};
