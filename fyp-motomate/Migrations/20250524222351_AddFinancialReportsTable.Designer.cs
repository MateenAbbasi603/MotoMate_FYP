...
namespace fyp_motomate.Migrations
{
    ...
    [Migration("20250524222351_AddFinancialReportsTable")]
    partial class AddFinancialReportsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("fyp_motomate.Models.FinancialReport", b =>
                {
            ...
            modelBuilder.Entity("fyp_motomate.Models.InvoiceItem", b =>
                {
            ...
            modelBuilder.Entity("fyp_motomate.Models.ToolInstance", b =>
                {
                    ...
                    b.ToTable("ToolInstances");
                });

            modelBuilder.Entity("fyp_motomate.Models.TransferToService", b =>
                {
            ...
            modelBuilder.Entity("fyp_motomate.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Super Admin",
                            Password = "$2a$11$KeQvwlP/cdQx87wsjUpLqu.D64.lklYXwSKO0klzoVmshFDPG78pW",
                            Phone = "+1234567890",
                            Role = "super_admin",
            ...
            modelBuilder.Entity("fyp_motomate.Models.FinancialReport", b =>
                {
                    b.HasOne("fyp_motomate.Models.User", "GeneratedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("fyp_motomate.Models.ToolInstance", b =>
                {
                    b.HasOne("fyp_motomate.Models.Inventory", "Tool")
                        .WithMany("Instances")
